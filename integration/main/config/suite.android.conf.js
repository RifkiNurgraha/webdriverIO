...
exports.config = {
    ...
    specs: [
        'integration/test/features/android/*.feature',
    ],
    exclude: [],
    maxInstances: 1,
    capabilities: [
        {
            ...
            deviceName: 'Device 1',
            avd: 'test_wd',
            app: '/Users/nakama/Documents/other/bukalapak/apk/Sample Android App Login Test_v4.0_apkpure.com.apk',
            commandTimeout: '7200',
            noReset: true,
            dontStopAppOnReset: false,
            show_on_first_run_allowed: false,
            show_welcome_page: false,
            // appActivity: 'com.tiket.gits.home.HomeActivity',
            // appPackage: 'com.tiket.gits',
            noSign: true,
        }
    ],
    ...
    cucumberOpts: {
        ...
        require: ['integration/main/steps/android/*.js'],
    ...
    afterScenario: function (uri, feature, scenario, sourceLocation) {
        ...
        //platform
        if ({ tags: "@android" }) {
            allureReporter.addFeature('ANDROID');
            allureReporter.addLabel('tag', 'android');
        };
        //severity
        if ({ tags: "@normal" }) {
